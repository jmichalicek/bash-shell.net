...
GIT_TAG="v$BUILD_NUM-$GIT_BRANCH"

TAG_JSON="{\"tag_name\": \"$GIT_TAG\", \"target_commitish\": \"$GIT_BRANCH\", \"name\": \"$GIT_TAG\", \"body\": \"Release of version $BUILD_NUM.\", \"draft\": false, \"prerelease\": false}"
