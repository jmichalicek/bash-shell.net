...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blog_post', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'posts', on_delete=models.SET_NULL, default=None, to=orm['accounts.User'], blank=True, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'blog.post': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'posts'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['accounts.User']", 'blank': 'True', 'null': 'True'}),
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'posts'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['bsblog.UserProfile']", 'blank': 'True', 'null': 'True'})
        },
        u'blog.tag': {
        ...
        u'bsblog.userprofile': {
            'Meta': {'object_name': 'UserProfile'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.User']", 'unique': 'True'})
        },
