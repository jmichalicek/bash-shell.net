...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.user_profile'
        db.delete_column(u'blog_post', 'user_profile_id')


    def backwards(self, orm):
        # Adding field 'Post.user_profile'
        db.add_column(u'blog_post', 'user_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'posts', on_delete=models.SET_NULL, default=None, to=orm['bsblog.UserProfile'], blank=True, null=True),
                      keep_default=False)
