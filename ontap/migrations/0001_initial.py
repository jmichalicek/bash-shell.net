# Generated by Django 3.0.5 on 2020-05-10 15:20
...
class Migration(migrations.Migration):
    # TODO: add BeerStylePage and then redo this migration
    # consider OnTapIndexPage as well which will have the current ontap data.
    initial = True

    dependencies = [
        ('wagtailcore', '0045_assign_unlock_grouppagepermission'),
        ('base', '0005_auto_20200510_1504'),  # add citext
    ]
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    modelcluster.fields.ParentalKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='yeasts', to='ontap.RecipePage'
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'recipe_page',
                    modelcluster.fields.ParentalKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='hops', to='ontap.RecipePage'
                    ),
                ),
            ],
            options={'ordering': ('recipe_page', 'sort_order'),},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'recipe_page',
                    modelcluster.fields.ParentalKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='fermentables', to='ontap.RecipePage'
                    ),
                ),
            ],
            options={'ordering': ('recipe_page', 'sort_order'),},
        ...
        migrations.AddIndex(
            model_name='beveragestyle', index=models.Index(fields=['name'], name='ontap_bever_name_7c5796_idx'),
        ),
        migrations.AddIndex(
            model_name='beveragestyle',
            index=models.Index(fields=['created_at'], name='ontap_bever_created_b72195_idx'),
        ),
        migrations.AddIndex(
            model_name='beveragestyle',
            index=models.Index(fields=['updated_at'], name='ontap_bever_updated_8d6811_idx'),
        ),
        migrations.AddIndex(
            model_name='recipepage', index=models.Index(fields=['name'], name='ontap_recip_name_cc7e08_idx'),
        ),
        migrations.AddIndex(
            model_name='recipepage', index=models.Index(fields=['recipe_type'], name='ontap_recip_recipe__899b23_idx'),
        ),
    ]
